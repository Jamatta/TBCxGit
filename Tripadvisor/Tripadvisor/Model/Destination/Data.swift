...
class dataView: ObservableObject {
    ...
    @Published var destinations: [Destination] = [
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Eiffel Tower", imageName: "eiffel_tower", description: "Iconic landmark.", destination: 5),
                MustSeePlace(name: "Louvre Museum", imageName: "louvre_museum", description: "Famous art museum.", destination: 5)
            ],
            hotels: [
                Hotel(name: "Ritz Paris", imageName: "ritz_paris", rating: 4.8, destination: 1),
                Hotel(name: "Hotel Plaza Athenee", imageName: "plaza_athenee", rating: 4.7, destination: 1)
            ],
            imageName: "paris"
        ),
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Statue of Liberty", imageName: "statue_of_liberty", description: "Symbol of freedom.", destination: 6),
                MustSeePlace(name: "Central Park", imageName: "central_park", description: "Famous urban park.", destination: 6)
            ],
            hotels: [
                Hotel(name: "The Plaza Hotel", imageName: "plaza_hotel", rating: 4.6, destination: 2),
                Hotel(name: "Four Seasons Hotel", imageName: "four_seasons", rating: 4.9, destination: 2)
            ],
            imageName: "new_york"
        ),
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Tokyo Tower", imageName: "tokyo_tower", description: "Observation tower.", destination: 7),
                MustSeePlace(name: "Senso-ji Temple", imageName: "sensoji_temple", description: "Historic Buddhist temple.", destination: 7)
            ],
            hotels: [
                Hotel(name: "Park Hyatt Tokyo", imageName: "park_hyatt", rating: 4.9, destination: 3),
                Hotel(name: "Keio Plaza Hotel", imageName: "keio_plaza", rating: 4.7, destination: 3)
            ],
            imageName: "tokyo"
        ),
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Colosseum", imageName: "colosseum", description: "Ancient amphitheater.", destination: 8),
                MustSeePlace(name: "Trevi Fountain", imageName: "trevi_fountain", description: "Baroque fountain.", destination: 8)
            ],
            hotels: [
                Hotel(name: "Hotel Eden", imageName: "hotel_eden", rating: 4.8, destination: 4),
                Hotel(name: "Grand Hotel de la Minerve", imageName: "minerve_hotel", rating: 4.6, destination: 4)
            ],
            imageName: "rome"
        ),
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Big Ben", imageName: "big_ben", description: "Symbol of London.", destination: 9),
                MustSeePlace(name: "British Museum", imageName: "british_museum", description: "Rich in art and culture.", destination: 9)
            ],
            hotels: [
                Hotel(name: "The Ritz London", imageName: "ritz_london", rating: 4.7, destination: 5),
                Hotel(name: "Shangri-La Hotel", imageName: "shangri_la", rating: 4.9, destination: 5)
            ],
            imageName: "london"
        ),
        Destination(
            ...
            mustSeePlaces: [
                MustSeePlace(name: "Sydney Opera House", imageName: "opera_house", description: "Iconic performing arts venue.", destination: 10),
                MustSeePlace(name: "Bondi Beach", imageName: "bondi_beach", description: "Famous beach destination.", destination: 10)
            ],
            hotels: [
                Hotel(name: "Four Seasons Hotel Sydney", imageName: "sydney_four_seasons", rating: 4.6, destination: 6),
                Hotel(name: "Park Hyatt Sydney", imageName: "park_hyatt_sydney", rating: 4.8, destination: 6)
            ],
            imageName: "sydney"
        )
    ]
